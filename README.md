...
The project was developed as a Computer Science final project and focuses on C++ programming, GUI development, data handling, multithreading, and third-party library integration.
...
Market data is retrieved through HTTP/S requests, parsed from JSON, and presented in an interactive chart-based interface.

This project demonstrates practical use of modern C++ concepts together with external libraries for UI, networking, JSON parsing, and data visualization.
